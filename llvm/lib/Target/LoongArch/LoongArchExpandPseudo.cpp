...
namespace {
  ...
  private:
    ...
    bool expandXINSERT_BOp(MachineBasicBlock &BB,
                           MachineBasicBlock::iterator I,
                           MachineBasicBlock::iterator &NMBBI);
    bool expandINSERT_HOp(MachineBasicBlock &BB,
                          MachineBasicBlock::iterator I,
                          MachineBasicBlock::iterator &NMBBI);
...
bool LoongArchExpandPseudo::expandXINSERT_FWOp(
  ...
  for (int i = 1; i < 8; i++ ){
    ...
    BuildMI(mainMBB, DL, TII->get(BLT)).addReg(LaneReg).addReg(RI).addMBB(blocks[i+1]);
  }

  BuildMI(mainMBB, DL, TII->get(LoongArch::B32)).addMBB(FirstMBB);

  BuildMI(FirstMBB, DL, TII->get(LoongArch::XVINSGR2VR_W), Dsttmp).addReg(SrcVecReg).addReg(RJ).addImm(7);
  BuildMI(FirstMBB, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  for (int i = 0; i < 7; i++ ){
    BuildMI(blocks[i+2], DL, TII->get(LoongArch::XVINSGR2VR_W), Dsttmp).addReg(SrcVecReg).addReg(RJ).addImm(i);
    BuildMI(blocks[i+2], DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);
  }


  sinkMBB->addSuccessor(exitMBB, BranchProbability::getOne());
  BuildMI(sinkMBB, DL, TII->get(LoongArch::XVORI_B), Dest).addReg(Dsttmp).addImm(0);
...
bool LoongArchExpandPseudo::expandINSERT_HOp(
  ...
  BuildMI(FirstMBB, DL, TII->get(LoongArch::VINSGR2VR_H), Dsttmp).addReg(SrcVecReg).addReg(SrcValReg).addImm(7);
  BuildMI(FirstMBB, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  for (int i = 0; i < 7; i++ ){
    BuildMI(blocks[i+2], DL, TII->get(LoongArch::VINSGR2VR_H), Dsttmp).addReg(SrcVecReg).addReg(SrcValReg).addImm(i);
    BuildMI(blocks[i+2], DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);
  }


  sinkMBB->addSuccessor(exitMBB, BranchProbability::getOne());
  BuildMI(sinkMBB, DL, TII->get(LoongArch::VORI_B), Dest).addReg(Dsttmp).addImm(0);
...
bool LoongArchExpandPseudo::expandXINSERT_BOp(
  ...
  BuildMI(SevenMBB, DL, TII->get(LoongArch::XVPICKVE2GR_W), R70).addReg(SrcVecReg).addImm(7);
  BuildMI(SevenMBB, DL, TII->get(ADDI), R7b1).addReg(ZERO).addImm(1);
  BuildMI(SevenMBB, DL, TII->get(BLT)).addReg(Ris).addReg(R7b1).addMBB(SevenMBB0);
  BuildMI(SevenMBB, DL, TII->get(ADDI), R7b2).addReg(ZERO).addImm(2);
  BuildMI(SevenMBB, DL, TII->get(BLT)).addReg(Ris).addReg(R7b2).addMBB(SevenMBB1);
  BuildMI(SevenMBB, DL, TII->get(ADDI), R7b3).addReg(ZERO).addImm(3);
  BuildMI(SevenMBB, DL, TII->get(BLT)).addReg(Ris).addReg(R7b3).addMBB(SevenMBB2);
  BuildMI(SevenMBB, DL, TII->get(LoongArch::B32)).addMBB(SevenMBB3);

  BuildMI(SevenMBB3, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(SevenMBB3, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0x00fff);
  BuildMI(SevenMBB3, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(SevenMBB3, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(SevenMBB3, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80_3);
  BuildMI(SevenMBB3, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(7);
  BuildMI(SevenMBB3, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(SevenMBB0, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(SevenMBB0, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(8);
  BuildMI(SevenMBB0, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xff00f);
  BuildMI(SevenMBB0, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(SevenMBB0, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(SevenMBB0, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(SevenMBB0, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(7);
  BuildMI(SevenMBB0, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(SevenMBB1, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(SevenMBB1, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(16);
  BuildMI(SevenMBB1, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xffff0);
  BuildMI(SevenMBB1, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0x0ff);
  BuildMI(SevenMBB1, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(SevenMBB1, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(SevenMBB1, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(7);
  BuildMI(SevenMBB1, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(SevenMBB2, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(SevenMBB2, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(24);
  BuildMI(SevenMBB2, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xfffff);
  BuildMI(SevenMBB2, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xf00);
  BuildMI(SevenMBB2, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(SevenMBB2, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(SevenMBB2, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(7);
  BuildMI(SevenMBB2, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(ZeroMBB, DL, TII->get(LoongArch::XVPICKVE2GR_W), R70).addReg(SrcVecReg).addImm(0);
  ...
  BuildMI(ZeroMBB3, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(ZeroMBB3, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0x00fff);
  BuildMI(ZeroMBB3, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(ZeroMBB3, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(ZeroMBB3, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80_3);
  BuildMI(ZeroMBB3, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(0);
  BuildMI(ZeroMBB3, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(ZeroMBB0, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(ZeroMBB0, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(8);
  BuildMI(ZeroMBB0, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xff00f);
  BuildMI(ZeroMBB0, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(ZeroMBB0, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(ZeroMBB0, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(ZeroMBB0, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(0);
  BuildMI(ZeroMBB0, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(ZeroMBB1, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(ZeroMBB1, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(16);
  BuildMI(ZeroMBB1, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xffff0);
  BuildMI(ZeroMBB1, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0x0ff);
  BuildMI(ZeroMBB1, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(ZeroMBB1, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(ZeroMBB1, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(0);
  BuildMI(ZeroMBB1, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(ZeroMBB2, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(ZeroMBB2, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(24);
  BuildMI(ZeroMBB2, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xfffff);
  BuildMI(ZeroMBB2, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xf00);
  BuildMI(ZeroMBB2, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(ZeroMBB2, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(ZeroMBB2, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(0);
  BuildMI(ZeroMBB2, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(OneMBB, DL, TII->get(LoongArch::XVPICKVE2GR_W), R70).addReg(SrcVecReg).addImm(1);
  ...
  BuildMI(OneMBB3, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(OneMBB3, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0x00fff);
  BuildMI(OneMBB3, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(OneMBB3, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(OneMBB3, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80_3);
  BuildMI(OneMBB3, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(1);
  BuildMI(OneMBB3, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(OneMBB0, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(OneMBB0, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(8);
  BuildMI(OneMBB0, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xff00f);
  BuildMI(OneMBB0, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(OneMBB0, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(OneMBB0, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(OneMBB0, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(1);
  BuildMI(OneMBB0, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(OneMBB1, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(OneMBB1, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(16);
  BuildMI(OneMBB1, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xffff0);
  BuildMI(OneMBB1, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0x0ff);
  BuildMI(OneMBB1, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(OneMBB1, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(OneMBB1, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(1);
  BuildMI(OneMBB1, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(OneMBB2, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(OneMBB2, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(24);
  BuildMI(OneMBB2, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xfffff);
  BuildMI(OneMBB2, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xf00);
  BuildMI(OneMBB2, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(OneMBB2, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(OneMBB2, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(1);
  BuildMI(OneMBB2, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(TwoMBB, DL, TII->get(LoongArch::XVPICKVE2GR_W), R70).addReg(SrcVecReg).addImm(2);
  ...
  BuildMI(TwoMBB3, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(TwoMBB3, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0x00fff);
  BuildMI(TwoMBB3, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(TwoMBB3, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(TwoMBB3, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80_3);
  BuildMI(TwoMBB3, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(2);
  BuildMI(TwoMBB3, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(TwoMBB0, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(TwoMBB0, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(8);
  BuildMI(TwoMBB0, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xff00f);
  BuildMI(TwoMBB0, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(TwoMBB0, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(TwoMBB0, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(TwoMBB0, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(2);
  BuildMI(TwoMBB0, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(TwoMBB1, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(TwoMBB1, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(16);
  BuildMI(TwoMBB1, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xffff0);
  BuildMI(TwoMBB1, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0x0ff);
  BuildMI(TwoMBB1, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(TwoMBB1, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(TwoMBB1, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(2);
  BuildMI(TwoMBB1, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(TwoMBB2, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(TwoMBB2, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(24);
  BuildMI(TwoMBB2, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xfffff);
  BuildMI(TwoMBB2, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xf00);
  BuildMI(TwoMBB2, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(TwoMBB2, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(TwoMBB2, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(2);
  BuildMI(TwoMBB2, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(ThreeMBB, DL, TII->get(LoongArch::XVPICKVE2GR_W), R70).addReg(SrcVecReg).addImm(3);
  BuildMI(ThreeMBB, DL, TII->get(ADDI), R7b1).addReg(ZERO).addImm(1);
  BuildMI(ThreeMBB, DL, TII->get(BLT)).addReg(Ris).addReg(R7b1).addMBB(ThreeMBB0);
  BuildMI(ThreeMBB, DL, TII->get(ADDI), R7b2).addReg(ZERO).addImm(2);
  BuildMI(ThreeMBB, DL, TII->get(BLT)).addReg(Ris).addReg(R7b2).addMBB(ThreeMBB1);
  BuildMI(ThreeMBB, DL, TII->get(ADDI), R7b3).addReg(ZERO).addImm(3);
  BuildMI(ThreeMBB, DL, TII->get(BLT)).addReg(Ris).addReg(R7b3).addMBB(ThreeMBB2);
  BuildMI(ThreeMBB, DL, TII->get(LoongArch::B32)).addMBB(ThreeMBB3);

  BuildMI(ThreeMBB3, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(ThreeMBB3, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0x00fff);
  BuildMI(ThreeMBB3, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(ThreeMBB3, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(ThreeMBB3, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80_3);
  BuildMI(ThreeMBB3, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(3);
  BuildMI(ThreeMBB3, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(ThreeMBB0, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(ThreeMBB0, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(8);
  BuildMI(ThreeMBB0, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xff00f);
  BuildMI(ThreeMBB0, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(ThreeMBB0, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(ThreeMBB0, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(ThreeMBB0, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(3);
  BuildMI(ThreeMBB0, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(ThreeMBB1, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(ThreeMBB1, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(16);
  BuildMI(ThreeMBB1, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xffff0);
  BuildMI(ThreeMBB1, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0x0ff);
  BuildMI(ThreeMBB1, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(ThreeMBB1, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(ThreeMBB1, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(3);
  BuildMI(ThreeMBB1, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(ThreeMBB2, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(ThreeMBB2, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(24);
  BuildMI(ThreeMBB2, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xfffff);
  BuildMI(ThreeMBB2, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xf00);
  BuildMI(ThreeMBB2, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(ThreeMBB2, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(ThreeMBB2, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(3);
  BuildMI(ThreeMBB2, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(FourMBB, DL, TII->get(LoongArch::XVPICKVE2GR_W), R70).addReg(SrcVecReg).addImm(4);
  ...
  BuildMI(FourMBB3, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(FourMBB3, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0x00fff);
  BuildMI(FourMBB3, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(FourMBB3, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(FourMBB3, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80_3);
  BuildMI(FourMBB3, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(4);
  BuildMI(FourMBB3, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(FourMBB0, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(FourMBB0, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(8);
  BuildMI(FourMBB0, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xff00f);
  BuildMI(FourMBB0, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(FourMBB0, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(FourMBB0, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(FourMBB0, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(4);
  BuildMI(FourMBB0, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(FourMBB1, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(FourMBB1, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(16);
  BuildMI(FourMBB1, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xffff0);
  BuildMI(FourMBB1, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0x0ff);
  BuildMI(FourMBB1, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(FourMBB1, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(FourMBB1, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(4);
  BuildMI(FourMBB1, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(FourMBB2, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(FourMBB2, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(24);
  BuildMI(FourMBB2, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xfffff);
  BuildMI(FourMBB2, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xf00);
  BuildMI(FourMBB2, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(FourMBB2, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(FourMBB2, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(4);
  BuildMI(FourMBB2, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(FiveMBB, DL, TII->get(LoongArch::XVPICKVE2GR_W), R70).addReg(SrcVecReg).addImm(5);
  ...
  BuildMI(FiveMBB3, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(FiveMBB3, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0x00fff);
  BuildMI(FiveMBB3, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(FiveMBB3, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(FiveMBB3, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80_3);
  BuildMI(FiveMBB3, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(5);
  BuildMI(FiveMBB3, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(FiveMBB0, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(FiveMBB0, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(8);
  BuildMI(FiveMBB0, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xff00f);
  BuildMI(FiveMBB0, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(FiveMBB0, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(FiveMBB0, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(FiveMBB0, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(5);
  BuildMI(FiveMBB0, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(FiveMBB1, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(FiveMBB1, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(16);
  BuildMI(FiveMBB1, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xffff0);
  BuildMI(FiveMBB1, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0x0ff);
  BuildMI(FiveMBB1, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(FiveMBB1, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(FiveMBB1, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(5);
  BuildMI(FiveMBB1, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(FiveMBB2, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(FiveMBB2, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(24);
  BuildMI(FiveMBB2, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xfffff);
  BuildMI(FiveMBB2, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xf00);
  BuildMI(FiveMBB2, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(FiveMBB2, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(FiveMBB2, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(5);
  BuildMI(FiveMBB2, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(SixMBB, DL, TII->get(LoongArch::XVPICKVE2GR_W), R70).addReg(SrcVecReg).addImm(6);
  ...
  BuildMI(SixMBB3, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(SixMBB3, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0x00fff);
  BuildMI(SixMBB3, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(SixMBB3, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(SixMBB3, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80_3);
  BuildMI(SixMBB3, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(6);
  BuildMI(SixMBB3, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(SixMBB0, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(SixMBB0, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(8);
  BuildMI(SixMBB0, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xff00f);
  BuildMI(SixMBB0, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xfff);
  BuildMI(SixMBB0, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(SixMBB0, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(SixMBB0, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(6);
  BuildMI(SixMBB0, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(SixMBB1, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(SixMBB1, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(16);
  BuildMI(SixMBB1, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xffff0);
  BuildMI(SixMBB1, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0x0ff);
  BuildMI(SixMBB1, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(SixMBB1, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(SixMBB1, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(6);
  BuildMI(SixMBB1, DL, TII->get(LoongArch::B32)).addMBB(sinkMBB);

  BuildMI(SixMBB2, DL, TII->get(LoongArch::SLLI_W), R7r80_3).addReg(SrcValReg).addImm(24);
  BuildMI(SixMBB2, DL, TII->get(LoongArch::SRLI_W), R7r80l_3).addReg(R7r80_3).addImm(24);
  BuildMI(SixMBB2, DL, TII->get(LoongArch::LU12I_W), R7r81l_3).addImm(0xfffff);
  BuildMI(SixMBB2, DL, TII->get(LoongArch::ORI32), R7r81_3).addReg(R7r81l_3).addImm(0xf00);
  BuildMI(SixMBB2, DL, TII->get(LoongArch::AND32), R7r82l_3).addReg(R70).addReg(R7r81_3);
  BuildMI(SixMBB2, DL, TII->get(LoongArch::OR32), R7r82_3).addReg(R7r82l_3).addReg(R7r80l_3);
  BuildMI(SixMBB2, DL, TII->get(LoongArch::XVINSGR2VR_W), tmp_Dst73).addReg(SrcVecReg).addReg(R7r82_3).addImm(6);
