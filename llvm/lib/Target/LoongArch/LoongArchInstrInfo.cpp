...
void LoongArchInstrInfo::copyPhysReg(MachineBasicBlock &MBB,
  ...
  else if (LoongArch::LASX256BRegClass.contains(DestReg)) { // Copy to LASX reg
...
bool LoongArchInstrInfo::isCopyInstrImpl(const MachineInstr &MI,
...
unsigned LoongArchInstrInfo::getOppositeBranchOpc(unsigned Opc) const {
  ...
  case LoongArch::VSETANYEQZ_B:   return LoongArch::VSETALLNEZ_B;
  case LoongArch::VSETANYEQZ_H:   return LoongArch::VSETALLNEZ_H;
  case LoongArch::VSETANYEQZ_W:   return LoongArch::VSETALLNEZ_W;
  case LoongArch::VSETANYEQZ_D:   return LoongArch::VSETALLNEZ_D;
  case LoongArch::VSETEQZ_V:   return LoongArch::VSETNEZ_V;
  case LoongArch::VSETALLNEZ_B:  return LoongArch::VSETANYEQZ_B;
  case LoongArch::VSETALLNEZ_H:  return LoongArch::VSETANYEQZ_H;
  case LoongArch::VSETALLNEZ_W:  return LoongArch::VSETANYEQZ_W;
  case LoongArch::VSETALLNEZ_D:  return LoongArch::VSETANYEQZ_D;
  case LoongArch::VSETNEZ_V:  return LoongArch::VSETEQZ_V;

  case LoongArch::XVSETANYEQZ_B:   return LoongArch::XVSETALLNEZ_B;
  case LoongArch::XVSETANYEQZ_H:   return LoongArch::XVSETALLNEZ_H;
  case LoongArch::XVSETANYEQZ_W:   return LoongArch::XVSETALLNEZ_W;
  case LoongArch::XVSETANYEQZ_D:   return LoongArch::XVSETALLNEZ_D;
  case LoongArch::XVSETEQZ_V:   return LoongArch::XVSETNEZ_V;
  case LoongArch::XVSETALLNEZ_B:  return LoongArch::XVSETANYEQZ_B;
  case LoongArch::XVSETALLNEZ_H:  return LoongArch::XVSETANYEQZ_H;
  case LoongArch::XVSETALLNEZ_W:  return LoongArch::XVSETANYEQZ_W;
  case LoongArch::XVSETALLNEZ_D:  return LoongArch::XVSETANYEQZ_D;
  case LoongArch::XVSETNEZ_V:  return LoongArch::XVSETEQZ_V;
  }
}
...
bool LoongArchInstrInfo::findCommutedOpIndices(MachineInstr &MI, unsigned &SrcOpIdx1,
