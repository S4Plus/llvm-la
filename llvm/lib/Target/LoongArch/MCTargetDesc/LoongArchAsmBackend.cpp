...
MCAsmBackend *llvm::createLoongArchAsmBackend(const Target &T,
  ...
  LoongArchABIInfo ABI = LoongArchABIInfo::computeTargetABI(STI.getTargetTriple(), STI.getCPU(), Options);
  return new LoongArchAsmBackend(T, MRI, STI.getTargetTriple(), STI.getCPU(), ABI.IsLPX32());
}
