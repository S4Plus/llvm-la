...
uint8_t *RuntimeDyldImpl::createStubFunction(uint8_t *Addr,
  ...
  if (Arch == Triple::aarch64 || Arch == Triple::aarch64_be) {
    ...
    return Addr + 4;
  //} else if (Arch == Triple::loongarch64) { // XXX: plt? for long function call
  //  writeBytesUnaligned(0x1400000c, Addr,    4); // lu12i.w $r12, %hi:<addr>
  //  writeBytesUnaligned(0x0380018c, Addr+4,  4); // ori $r12, $r12, %lo:<addr>
  //  writeBytesUnaligned(0x1600000c, Addr+8,  4); // lu32i.d $r12, %higher:<addr>
  //  writeBytesUnaligned(0x0300018c, Addr+12, 4); // lu52i.d $r12, $r12, %highest:<addr>
  //  writeBytesUnaligned(0x4c000180, Addr+16, 4); // jirl $r0, $r12, 0
