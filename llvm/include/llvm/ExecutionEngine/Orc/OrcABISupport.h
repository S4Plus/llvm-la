...
// @brief LoongArch32 support.
//
// LoongArch32 supports lazy JITing.
class OrcLoongArch32_Base {
public:
  static const unsigned PointerSize = 4;
  ...
  ///        the nearest page size.
  ///
  ///   E.g. Asking for 4 stubs on LoongArch32, where stubs are 8-bytes, with 4k
  /// pages will return a block of 512 stubs (4096 / 8 = 512). Asking for 513
  /// will return a block of 1024 (2-pages worth).
...
class OrcLoongArch32 : public OrcLoongArch32_Base {
public:
  static void writeResolverCode(uint8_t *ResolveMem, JITReentryFn Reentry,void *CallbackMgr)
  { OrcLoongArch32_Base::writeResolverCode(ResolveMem, Reentry, CallbackMgr); }
};

// @brief LoongArch64 support.
//
// LoongArch64 supports lazy JITing.
...
public:
  ...
  ///        the nearest page size.
  ///
  ///   E.g. Asking for 4 stubs on LoongArch64, where stubs are 8-bytes, with 4k
  /// pages will return a block of 512 stubs (4096 / 8 = 512). Asking for 513
  /// will return a block of 1024 (2-pages worth).
  static Error emitIndirectStubsBlock(IndirectStubsInfo &StubsInfo,unsigned MinStubs, void *InitialPtrVal);
};
