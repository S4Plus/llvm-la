...
int main(int argc, char **argv) {
  ...
  // loongarch64:      Shadow scale=2 offset=0x004400000000
  // loongarch64-NEXT: Shadow #0: [1140000000-1180000000) (1GB)
  // loongarch64-NEXT: Shadow #1: [1380000000-13c0000000) (1GB)
  // loongarch64-NEXT: Shadow #2: [14c0000000-1500000000) (1GB)
