...
# SO_SYM:   3 .tdata        00000009 0000000120020000 DATA
# SO_SYM: SYMBOL TABLE:
# SO_SYM: 0000000000000000 l     O .tdata 00000000 x
# SO_SYM: 0000000000000005 l     O .tdata 00000000 z
# SO_SYM: 0000000000000001 g     O .tdata 00000000 y
...
# DIS:      120010000:  0c 00 00 14     lu12i.w $r12, 0
# DIS-NEXT: 120010004:  8c 01 80 03     ori     $r12, $r12, 0
# DIS-NEXT: 120010008:  0c 00 00 16     lu32i.d $r12, 0
# DIS-NEXT: 12001000c:  8c 01 00 03     lu52i.d $r12, $r12, 0
# DIS-NEXT: 120010010:  0d 00 00 14     lu12i.w $r13, 0
# DIS-NEXT: 120010014:  ad 05 80 03     ori     $r13, $r13, 1
# DIS-NEXT: 120010018:  0d 00 00 16     lu32i.d $r13, 0
# DIS-NEXT: 12001001c:  ad 01 00 03     lu52i.d $r13, $r13, 0
# DIS-NEXT: 120010020:  0f 00 00 14     lu12i.w $r15, 0
# DIS-NEXT: 120010024:  ef 15 84 03     ori     $r15, $r15, 261
# DIS-NEXT: 120010028:  0f 00 00 16     lu32i.d $r15, 0
# DIS-NEXT: 12001002c:  ef 01 00 03     lu52i.d $r15, $r15, 0
