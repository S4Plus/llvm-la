...
**LIBOMP_ARCH** = ``aarch64|arm|i386|mic|mips|mips64|ppc64|ppc64le|x86_64|loongarch64``
...
**LIBOMP_OMPT_SUPPORT** = ``ON|OFF``
  ...
  This option is supported and ``ON`` by default for x86, x86_64, AArch64, PPC64 
  and loongarch64 on Linux* and macOS*.
